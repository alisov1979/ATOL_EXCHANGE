...
public class Row implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1753034438098693067L;
	...
	public void addProperty(String type, String name, String value) {
		...
		this.property.add(new Property(type, name, value));
	}
	...
	public Row add(String type, String name, java.lang.Object value) {
		...
		this.property.add(new Property(type, name, String.valueOf(value)));
